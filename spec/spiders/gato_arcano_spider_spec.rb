...
RSpec.describe GatoArcanoSpider, :spider, engine: :woocommerce do
  ...
  describe "#parse_index_node" do
    ...
    context "with a preorder price index product node" do
      let(:filename) { File.join("spec/fixtures/stores", fixture_directory, "product_index_node_preorder.html") }

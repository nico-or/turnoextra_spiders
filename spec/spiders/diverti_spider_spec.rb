...
RSpec.describe DivertiSpider do
  ...
  describe "#parse_index_node" do
    context "with a regular index product node" do
      ...
      let(:expected) do
        {
          url: "https://www.diverti.cl/juegos-de-mesa/dixit-odyssey-729.html",
          title: "Dixit Odyssey",
          price: 29_990,
          stock: true,
          image_url: "https://www.diverti.cl/435550-large_default/dixit-odyssey.jpg"
        }
      end
    ...
    context "with a discounted price index product node" do
      ...
      let(:expected) do
        {
          url: "https://www.diverti.cl/juegos-de-mesa/mala-leche-1301.html",
          title: "Mala Leche",
          price: 20_990,
          stock: true,
          image_url: "https://www.diverti.cl/435680-large_default/mala-leche.jpg"
        }
      end
    ...
    context "with an out-of-stock index product node" do
      ...
      let(:expected) do
        {
          url: "https://www.diverti.cl/juegos-de-mesa/trio-7949.html",
          title: "Trio",
          price: 13_990,
          stock: false,
          image_url: "https://www.diverti.cl/433517-large_default/trio.jpg"
        }
      end
  ...
  describe "#next_page_url" do
    context "with an index page that has a next page link" do
      ...
      it "has a next page" do
        ...
        expected = "https://www.diverti.cl/juegos-de-mesa-16?page=2"
